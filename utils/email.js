    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      if (
        ...
        const tx = nodemailer.createTransport({
          service: 'gmail',
          auth: {
            user: process.env.GMAIL_USER || process.env.EMAIL_USER || process.env.EMAIL_USERNAME,
            pass: process.env.GMAIL_PASS || process.env.EMAIL_PASS || process.env.EMAIL_PASSWORD,
          },
        });
